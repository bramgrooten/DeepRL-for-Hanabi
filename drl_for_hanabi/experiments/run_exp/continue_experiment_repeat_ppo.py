...
from PPO.PPO_cheat import PPO_Agent
'''
...
if new_session == 1:
    utils_exps.set_random_seed(exp['random_seed'])
...
data_folder = f"../data/{start_date_exp}_{type_exp}/"


algo = PPO_Agent(runtime=new_runtime,
                 show_epoch_nr=100,
                 ...
                 save_model_every_n_epochs=1e5,
                 save_data_folder=data_folder,
                 save_params_path=new_policy)
